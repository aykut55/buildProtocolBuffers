...
#include "src/person/person.pb.h"
...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_src_2fperson_2fperson_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_src_2fperson_2fperson_2eproto = nullptr;
const ::uint32_t
    TableStruct_src_2fperson_2fperson_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
...
const char descriptor_table_protodef_src_2fperson_2fperson_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027src/person/person.proto\"1\n\006Person\022\014\n\004n"
    "ame\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005email\030\003 \001(\tb\006pr"
    "oto3"
};
static ::absl::once_flag descriptor_table_src_2fperson_2fperson_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_src_2fperson_2fperson_2eproto = {
    false,
    false,
    84,
    descriptor_table_protodef_src_2fperson_2fperson_2eproto,
    "src/person/person.proto",
    &descriptor_table_src_2fperson_2fperson_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_src_2fperson_2fperson_2eproto::offsets,
    file_level_enum_descriptors_src_2fperson_2fperson_2eproto,
    file_level_service_descriptors_src_2fperson_2fperson_2eproto,
};
// ===================================================================
...
constexpr auto Person::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_src_2fperson_2fperson_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_src_2fperson_2fperson_2eproto),
         ::std::false_type{});
