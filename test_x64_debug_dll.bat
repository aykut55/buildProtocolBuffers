...
echo ==========================================
echo   TEST: x64 Debug DLL Build Only
echo ==========================================

:: Configuration
set VSVERSION=Visual Studio 17 2022
set PROTOBUF_SRC=C:\protobuf\protobuf321
set PROTOBUF_BUILD_DIR=C:\protobuf\protobuf-builds\x64-Debug-DLL-TEST

echo Testing x64 Debug DLL build...
...
:: CMake configuration for Debug DLL
