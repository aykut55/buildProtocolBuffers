...
echo ==========================================
echo   TEST: Win32 Release DLL Build Only
echo ==========================================

:: Configuration
set VSVERSION=Visual Studio 17 2022
set PROTOBUF_SRC=C:\protobuf\protobuf321
set PROTOBUF_BUILD_DIR=C:\protobuf\protobuf-builds\Win32-Release-DLL-TEST

echo Testing Win32 Release DLL build...
...
:: CMake configuration for Release DLL
